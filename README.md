...
- 6.*简要说一下 `@autoreleasePool` 的数据结构，为什么要做成这个样子？ - [链接](https://github.com/liberalisman/iOS-InterviewQuestion-collection/blob/master/内存管理/6.第六题.md)
...
- 16.*内存中的5大区分别是什么？ - [链接](https://github.com/YiYiZheng/iOS-InterviewQuestion-collection/blob/master/内存管理/16.第十六题.md)
